...
public class WaterPokemon extends Pokemon {
    ...
    public boolean attack(final Pokemon opponent) {
        ...
        if (opponent.getHitPoints() >= 0) {
            //cue specialty attack path
            double rand = Math.random();
            if (specialtyProbability > rand && opponent.pokeType != PokemonType.ELECTRIC) {
                //execute
//                Pikachu executes a specialty attack... THUNDERBOLT!!! <br>
//                Bubba has been defeated!
                ...
                System.out.println(this.getName() + " missed their specialty attack!");
            }
        }
        return false;
    }
